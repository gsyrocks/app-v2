...
import { LocationSectionWrapper } from './LocationSectionWrapper'
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 0 11-6 0 3 0 116 0z" />
      </svg>
    )
  },
  {
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
              ...
              {activeSection === 'sponsorship' && <SponsorshipSection user={user} />}
