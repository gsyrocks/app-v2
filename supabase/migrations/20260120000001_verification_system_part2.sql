-- =====================================================
-- Community Verification & Corrections System (Part 2)
-- Adds verification tables and image columns
-- Created: 2026-01-20
-- =====================================================
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'climb_verifications' AND policyname = 'Public read verifications') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'climb_verifications' AND policyname = 'Authenticated create verification') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'climb_verifications' AND policyname = 'Authenticated delete own verification') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'grade_votes' AND policyname = 'Public read grade votes') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'grade_votes' AND policyname = 'Authenticated create grade vote') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'grade_votes' AND policyname = 'Authenticated update own grade vote') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'grade_votes' AND policyname = 'Authenticated delete own grade vote') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'climb_corrections' AND policyname = 'Public read corrections') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'climb_corrections' AND policyname = 'Authenticated create correction') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'climb_corrections' AND policyname = 'Authenticated update own correction') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'correction_votes' AND policyname = 'Public read correction votes') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'correction_votes' AND policyname = 'Authenticated create correction vote') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'correction_votes' AND policyname = 'Authenticated delete own correction vote') THEN
