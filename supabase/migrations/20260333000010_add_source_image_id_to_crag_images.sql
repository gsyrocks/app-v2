...
CREATE INDEX IF NOT EXISTS idx_crag_images_source_image_id
ON public.crag_images(source_image_id);

UPDATE public.crag_images
SET source_image_id = linked_image_id
WHERE source_image_id IS NULL
  AND linked_image_id IS NOT NULL;
