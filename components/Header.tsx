    ...
    <header ref={headerRef} className={`fixed top-0 left-0 right-0 z-[5000] bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800 shadow-sm dark:shadow-none ${
      ...
      <div className="container mx-auto px-4 py-2 flex justify-between items-center gap-4">
        ...
        <nav className="flex items-center gap-1">
          ...
          <Link prefetch={false} href="/gym-owners" className="hidden md:block px-3 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            Gym Owners
          </Link>
